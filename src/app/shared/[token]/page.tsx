 ...
 const fetchSharedDocument = useCallback(async () => {
  ...
  const handleView = async () => {
    ...
    try {
      ...
      // Directly open the view URL in new tab
      const viewUrl = `http://localhost:5000/api/dms/shared/${token}/view`;
      window.open(viewUrl, '_blank');
      
      // Reset viewing state after a delay
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="flex items-center gap-4 p-4 bg-gray-50/50 rounded-xl border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{document.uploaded_by}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50/50 rounded-xl border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{formatFileSize(document.file_size)}</p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-slate-50/50 rounded-2xl p-6 border border-gray-100/50">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="font-medium text-gray-900">{document.file_extension.toUpperCase()}</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                <span className="text-gray-600">Folder Structure</span>
                <span className="font-medium text-gray-900 text-right">{document.folder_structure || 'General'}</span>
              </div>
