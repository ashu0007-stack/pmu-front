...
import { officialData } from '../../TrainingReports/trainingData';
import { Users } from 'lucide-react';
import { Pagination } from '@/components/shared/Pagination';

const PAGE_SIZE = 20;

export const OfficialParticipantTable: FC<any> = ({OnAddNew}) => {

  const [page, setPage] = useState(1);

  const totalPages = Math.ceil(officialData.length / PAGE_SIZE);
          ...
          <tbody>
            {paginatedData.map((row: any, index: number) => (
              ...
              >
                ...
                <td className="p-2 text-center">{row.position}</td>
